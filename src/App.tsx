  ...
  const blogPosts = [
    {
      ...
      excerpt: "웹 상에서 3D 요소를 자연스럽게 렌더링하고 사용자 인터랙션을 처리하는 기술적인 도전에 대해 기록합니다.",
      date: "2025.12.15",
    ...
    },
    {
      ...
      excerpt: "보안이 중요한 엔터프라이즈 환경에서 JWT를 활용한 인증 및 인가 시스템을 구축한 과정을 상세히 공유합니다.",
      date: "2025.11.20",
          ...
          <div className="relative flex flex-col items-center group">
            ...
            <div className={`flex flex-col items-center gap-3 animate-bounce`}>
              ...
              <div className="flex flex-col items-center">
                <span className={`text-[10px] md:text-xs font-black tracking-[0.4em] uppercase ${pointColor} drop-shadow-sm`}>Click to Bloom</span>
                <span className="text-[8px] md:text-[9px] font-bold opacity-30 tracking-[0.2em] uppercase mt-1">Start your garden in Main</span>
              </div>
            </div>
          </div>
        </div>
